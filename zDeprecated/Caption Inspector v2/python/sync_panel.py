"""The Sync QC tab of the v2 desktop app.
...
from drift_report import headline_sentence, write_report
...
class SyncQCPanel(ttk.Frame):
    ...
    def _draw_plot(self):
        ...
        xs = [sample["caption_seconds"] for sample in samples]
