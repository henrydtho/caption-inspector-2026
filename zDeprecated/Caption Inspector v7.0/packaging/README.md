...
`packaging/dist/Caption-Inspector-v7.0-windows-x64.zip` to hand to another
...
```
python3 packaging/stage_model.py --model medium --download "Caption Inspector v7.0.app"
```
