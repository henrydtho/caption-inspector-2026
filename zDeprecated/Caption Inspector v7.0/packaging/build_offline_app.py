#!/usr/bin/env python3
"""Build a fully self-contained Caption Inspector v7.0.app.
...
APP_NAME = "Caption Inspector v7.0"
BUNDLE_ID = "com.local.captioninspector.v70"
APP_VERSION = "7.0"
    ...
    if app.exists():
        ...
        if not marker.exists() and not force:
            raise SystemExit(
                ...
                "  python3 packaging/build_offline_app.py --output ~/Desktop/'Caption Inspector v7.0.app'\n"
