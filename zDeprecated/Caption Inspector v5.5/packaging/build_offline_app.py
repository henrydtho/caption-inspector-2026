#!/usr/bin/env python3
"""Build a fully self-contained Caption Inspector v5.5.app.
...
APP_NAME = "Caption Inspector v5.5"
BUNDLE_ID = "com.local.captioninspector.v55"
APP_VERSION = "5.5"
    ...
    if app.exists():
        ...
        if not marker.exists() and not force:
            raise SystemExit(
                ...
                "  python3 packaging/build_offline_app.py --output ~/Desktop/'Caption Inspector v5.5.app'\n"
